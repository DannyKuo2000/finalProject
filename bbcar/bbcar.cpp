...
void BBCar::goStraight( double speed ){
    servo0.set_factor(1);
    servo1.set_factor(1);
    servo0.set_speed(speed + 20);
    servo1.set_speed(-speed);
}

void BBCar::activeWeak (double speed) {
    servo0.set_factor(1);
    servo1.set_factor(1);
...
*/
void BBCar::turn( double speed0, double speed1 ){
    servo0.set_factor(1);
    servo1.set_factor(1);
    servo0.set_speed(speed0);
    servo1.set_speed(-speed1);
}
...
void BBCar::turnByStanding( double speed, double factor ){
    if(factor>0){ // turn left
        servo0.set_factor(1);
        servo1.set_factor(1);
        servo0.set_speed(-speed);
        servo1.set_speed(-speed);
    }
    else if(factor<0){ // turn right
        servo0.set_factor(1);
        servo1.set_factor(1);
        servo0.set_speed(speed);
        servo1.set_speed(speed);
